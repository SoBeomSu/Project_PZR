...
public:
	...
	//손으로 오브젝트 잡기 시작
	void virtual StartGrab(class UMotionControllerComponent* MontionComp, bool IsRight) {};
	//손으로 오브젝트 잡기 종료
	void virtual StopGrab(class UMotionControllerComponent* MontionComp, bool IsRight) {};
	//컨트롤러를 통해 오브젝트 회전
